...
export async function verifyAfterAction(options) {
    ...
    const shouldRun = options.skipCommand !== true &&
    ...
    return {
        files,
        command: { command: command, exit_code: outcome.exit_code, output: processed.inline, duration_ms: outcome.duration_ms, timed_out: outcome.timed_out },
        passed,
